...
namespace ArceusCreations.Server.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Pokemon_Moves_Move1Id",
                        column: x => x.Move1Id,
                        principalTable: "Moves",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Pokemon_Moves_Move2Id",
                        column: x => x.Move2Id,
                        principalTable: "Moves",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Pokemon_Moves_Move3Id",
                        column: x => x.Move3Id,
                        principalTable: "Moves",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Pokemon_Moves_Move4Id",
                        column: x => x.Move4Id,
                        principalTable: "Moves",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_Pokemon_Types_TypeId",
                        column: x => x.TypeId,
                        principalTable: "Types",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pokemon_Move1Id",
                table: "Pokemon",
                column: "Move1Id");

            migrationBuilder.CreateIndex(
                name: "IX_Pokemon_Move2Id",
                table: "Pokemon",
                column: "Move2Id");

            migrationBuilder.CreateIndex(
                name: "IX_Pokemon_Move3Id",
                table: "Pokemon",
                column: "Move3Id");

            migrationBuilder.CreateIndex(
                name: "IX_Pokemon_Move4Id",
                table: "Pokemon",
                column: "Move4Id");
